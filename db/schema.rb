...
ActiveRecord::Schema.define(version: 20180501055053) do
  ...
  create_table "charities_jobs", id: false, force: :cascade do |t|
  ...
  create_table "jobs", force: :cascade do |t|
    ...
    t.index ["charity_id"], name: "index_jobs_on_charity_id"
  end
